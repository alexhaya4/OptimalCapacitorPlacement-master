...
start=0;
x=0;
[LSI1,LSI2,Vm,PTloss,QTloss,power_f_active]=pf_85(start,x);
disp(' ')
disp('======================================================')
disp('Results of 85 bus system without compansation')
disp(' ')
...
NP=250;              % number particle
T=60;               % max of iteration
...
for i=1:a
    ...
    disp(' ')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[LSI1,LSI2,Vm,PTloss,QTloss,power_f_active]=pf_85(start,gparticle.pos);
...
disp(' ')
disp('======================================================')
disp('Results of 85 bus system with compansation, Case 1')
disp(' ')
disp(['Total active loss is: ' num2str(PTloss) ' kW'])
Kp=168; % $/Kw
Kc=5; % $/Kvar
...
disp(' ')
disp('======================================================')
disp('Results of 85 bus system with compansation, Case 2')
disp(' ')
disp(['Total active loss is: ' num2str(PTloss) ' kW'])
Kp=168; % $/Kw
Kc=5; % $/Kvar
