...
start=0;
x=0;
[LSI1,LSI2,Vm,PTloss,QTloss,power_f_active]=pf_34(start,x);
disp(' ')
disp('======================================================')
disp('Results of 34 bus system without compansation')
disp(' ')
...
for i=1:a
    ...
    disp(' ')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[LSI1,LSI2,Vm,PTloss,QTloss,power_f_active]=pf_34(start,gparticle.pos);
figure(1)
hold on
plot(abs(Vm),'-r^')
...
disp(' ')
disp('======================================================')
disp('Results of 34 bus system with compansation, Case 1')
disp(' ')
disp(['Total active loss is: ' num2str(PTloss) ' kW'])
Kp=168; % $/Kw
Kc=5; % $/Kvar
...
disp(' ')
disp('======================================================')
disp('Results of 34 bus system with compansation, Case 2')
disp(' ')
disp(['Total active loss is: ' num2str(PTloss) ' kW'])
Kp=168; % $/Kw
Kc=5; % $/Kvar
